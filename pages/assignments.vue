<template>
  <div>
    <main>
      ...
      <h3>Daily Code Journal</h3>
      <ul>
        <li>Total Weight: 20%</li>
        <li>4% per submission</li>
        <li>Due: 8am the following day (no late submissions)</li>
      </ul>
      <h3>Assignments</h3>
      <ul>
        <li>Total Weight: 50%</li>
        <li>Due: assigned on a per-assignment basis</li>
      </ul>
      <h3>Achievements</h3>
      <ul>
        <li>Total weight: 30%</li>
        <li>5% per achievement</li>
        <li>Due: varies by category</li>
      </ul>
